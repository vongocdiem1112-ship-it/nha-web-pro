...
## 🚀 Quick Setup (UPDATED - Automatic!)

### **1. One-Command Setup**

This app uses Supabase with **smart auto-connection**. Just run:

```bash
# Auto-detect, test, and fix all Supabase connections
npm run supabase
```

This will:
- ✅ Test PostgreSQL direct connection (preferred)
- ✅ Test Supabase client connection (fallback)  
- ✅ Auto-create database schema if needed
- ✅ Add sample data (6 users, 8 listings, 5 news)
...
- **URL**: `https://zewyoonmkknfbgrmsfhw.supabase.co`
- **Project**: `zewyoonmkknfbgrmsfhw` 
- **Connection**: Direct PostgreSQL + Client API
